...
public class StepCounter {
	 ...
	 * 
	 * Our first idea which counts a step only if a peak crosses a peak threshold followed by a trough which crosses a trough threshold
	 * 
	 * @param times
	 ...
	 * @param times  a 1d array with the elapsed times in milliseconds for each row
	 *            in the sensorData array
	 * @param sensorData  a 2D-array where rows represent successive sensor data
	 *            samples, and the columns represent different sensors. We
	 *            assume there are 6 columns. Columns 0-2 are data from the x,
	 *            y, and z axes of an accelerometer, and 3-5 are data from the
	 *            x,y, and z axes of a gyro
